...
public class EquationViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(Equation equationObject)
    {
      ...
      if(equationObject.getStatus()==1)equation.setText(equationObject.getNumber1()+equationObject.getOperation()+equationObject.getNumber2()+ " = "+ equationObject.getResult());

      else equation.setText(equationObject.getNumber1()+equationObject.getOperation()+equationObject.getNumber2());;
